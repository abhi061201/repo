...
class MyPostStructure extends StatelessWidget {
  List<PostModel> list;
  int index;
  
  MyPostStructure({super.key, required this.list, required this.index});
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: Card(
            child: Center(child: Text(list[index].body.toString())),
          ),
        ),
        // Row(children: [
        //   IconButton(
